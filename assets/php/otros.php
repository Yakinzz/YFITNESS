...
<html lang="es" dir="ltr">
 ...
 <div class="container">
  ...
  session_start();
  $database = conectar();
  $ejercicios = 'SELECT ID_Ejercicio,Nombre_ejercicio,Descripcion,Grupo,Logo FROM ejercicios WHERE Grupo="OTROS"';
    ...
    ?>
      ...
      <div class="image <?php echo $filaDatos["Logo"] ?>">
          ...
          <h2> <?php 
            ...
            <div class="more">
              <a class="read-more">Ejercicios <span>Varios</span></a>
